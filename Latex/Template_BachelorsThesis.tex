...
Plug-in should change color scheme accordingly to color scheme of Adobe Premiere Pro.
	\end{description}
...
User wants to export a project to NARRA. Requirements: User has to be logged in. Basic scenario:
	\begin{enumerate}
		\item User selects desired items from a list by clicking on the checkboxes near items.
